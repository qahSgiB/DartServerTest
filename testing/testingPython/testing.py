def test():
    ...
    apiKey = 'AIzaSyCOcvg_f5GqfvO6sbjWLNO_TFNWJdURiJk'

    pewdiepieChannel = YoutubeChannel('pewdiepie', apiKey)
    tseriesChannel = YoutubeChannel('tseries', apiKey)

    print(pewdiepieChannel.getSubscribersCount()-tseriesChannel.getSubscribersCount())
